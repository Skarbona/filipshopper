...
class SinglePageCollapse extends React.Component {
    ...
    reviewsGeneratorHelper = () => {
        ...
        return reviews.map(review => <SingleReview key={review.name} review={review} /> );
    };
        ...
        return (
            <ul className="collapsible" ref={collapse}>
                <li>
                    ...
                    <div className="collapsible-body"><p>{extra}</p></div>
                </li>
                <li>
                    <div className="collapsible-header">
...
const mapStateToProps = (state , ownProps) => {
    return { reviews : state.reviews[ownProps.id] ? state.reviews[ownProps.id] : [] }
 };


export default connect(mapStateToProps, { initReviews })(SinglePageCollapse);
